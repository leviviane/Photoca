...
from app.models import db, Photocard_listing, Review, User
...
def get_all_photocard_listing():
    photocard_listings = Photocard_listing.query.all()
...
def get_reviews(postId):
    photocard_listing = Photocard_listing.query.get(postId)
